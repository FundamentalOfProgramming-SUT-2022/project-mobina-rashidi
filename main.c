...
void removechar(char * str, char char_remove) {
...
void find_str(char * filename, char * str, char * type, char * type2, int number, int n) {
   ...
   char * inputstring = read_file(filename);
   ...
   if (n == 1) {
      if (strcmp(type2, "-byword") == 0)
         byword = 1;

      else if (strcmp(type2, "-count") == 0)
         char_num = 1;

      else if (strcmp(type2, "-at") == 0)
         at_num = 0;

      else if (strcmp(type2, "-all") == 0)
         all = 1;
   ...
   for (indexctr = 0; indexctr <= strlen(inputstring); indexctr++) {
      ...
      if (inputstring[indexctr] == ' ' || inputstring[indexctr] == '\0' || inputstring[indexctr] == '\n') {
         ...
         totalwords++;
         charecter[i] = indexctr - wordindex;
   ...
   for (indexctr = 0; indexctr < totalwords; indexctr++) {
      ...
      int l, t, j;
      char * str1 = words[indexctr];
      int size_for = strlen(str1);

      for (l = 0; str[l] != '\0'; l++);

      for (t = 0, j = 0; str1[t] != '\0' && str[j] != '\0'; t++) {
         if (str1[t] == str[j]) {
      ...
      if (j == l) {
         ...
         if (starfirst == 1) {
            if (charecter[indexctr] + t - j != charecter[indexctr])
               k++;
         }
         ...
         if (byword == 1 && char_num == 0 && at_num == 1 && num == 0 && all == 0) {
         ...
         if (byword == 1 && char_num == 0 && at_num == 0 && num == 0 && all == 0) {
            printf("%d\n", indexctr);
            break;
         }

         if (num == 1 && byword == 0 && char_num == 0 && all == 0 && at_num == 0) {
            printf("%d\n", charecter[indexctr] + j - t);
            break;
         }

         if (at_num == 1 && all == 1 && byword == 0 && char_num == 0 && num == 0) {
            printf("warning input!");
            break;
         }

         if (all == 1 && byword == 1 && at_num == 0 && char_num == 0 && num == 0)
            printf("%d ", indexctr);
   ...
   if (byword == 1 && at_num == 1 && number > count_number)
      printf("-1\n");

   if (char_num == 1 && byword == 0 && at_num == 0 && num == 0 && starfirst == 0 && starlast == 0)
      printf("%d\n", count_number);

   if (char_num == 1 && byword == 0 && at_num == 0 && num == 0 && starfirst != 0 && starlast == 0)
      printf("%d\n", k);

   if (char_num == 1 && byword == 0 && at_num == 0 && num == 0 && starfirst == 0 && starlast == 1)
      printf("%d\n", h);
...
int main() {
   ...
   do {
      ...
      if (command_size > 0) {
         ...
         else if (strcmp(items[0], "insertstr") == 0) {
            //now get next params:
            if (strcmp(items[1], "--file") == 0) {
         ...
         //action [find]:
         else if (strcmp(items[0], "find") == 0) {
            int num = 0;
            int number;
            int n = 0;
            if (strcmp(items[1], "--str") == 0) {
               if (strcmp(items[3], "--file") == 0) {

                  if (strcmp(items[5], "-at") == 0) {

                     sscanf(items[6], "%d", & number);
                     int y = number;

                     if (strcmp(items[7], "-count") == 0 || strcmp(items[7], "-all") == 0 || strcmp(items[7], "-byword") == 0) {
                        char * type2 = items[7];
                        char * type = items[5];
                        char * filename = items[4];
                        char * str = items[2];

                        n = 1;
                        find_str(filename, str, type, type2, number, n);
                     }
                  } else {
                     num = 1;
                  }

                  if (strcmp(items[5], "-count") == 0 || strcmp(items[5], "-all") == 0 || strcmp(items[5], "-byword") == 0) {

                     if (strcmp(items[6], "-count") == 0 || strcmp(items[6], "-all") == 0 || strcmp(items[6], "-byword") == 0) {
                        char * type2 = items[6];
                        char * type = items[5];
                        char * filename = items[4];
                        char * str = items[2];
                  ...
                  if (n == 0) {
                     ...
                     find_str(filename, str, type, x, number, n);
                  }
         ...
         else if (strcmp(items[0], "removestr") == 0) {
            //now get next params:
            if (strcmp(items[1], "--file") == 0) {
         ...
         //action [copystr]:
         else if (strcmp(items[0], "copystr") == 0) {
            //now get next params:
            if (strcmp(items[1], "--file") == 0) {
               if (strcmp(items[3], "--pos") == 0) {
                  char * param6 = items[4]; //<line no>:<start position>
         ...
         else if (strcmp(items[0], "cutstr") == 0) {
            //now get next params:
            if (strcmp(items[1], "--file") == 0) {
               if (strcmp(items[3], "--pos") == 0) {
                  char * param6 = items[4]; //<line no>:<start position>
         ...
         else if (strcmp(items[0], "pastestr") == 0) {
            //now get next params:
            if (strcmp(items[1], "--file") == 0) {
               if (strcmp(items[3], "--pos") == 0) {
                  char * param6 = items[4]; //<line no>:<start position>
         ...
         } else if (strcmp(items[0], "auto-indent") == 0) {
            format(items[1]);
         } else if (strcmp(items[0], "compare") == 0) {
            compare(items[1], items[2]);
         } else if (strcmp(items[0], "tree") == 0) {
